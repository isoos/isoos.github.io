...
z.b=$.$get$DB()
P.JS("Running PWA, version: 2017-03-22T13:59:20.000Z")
X.W7(z)},"$0","Zv",0,0,2]},1]]
setupProgram(dart,0)
...
try{(void 0).$method$($argumentsExpr$)}catch(z){return z.message}}())},"BX","$get$BX",function(){return H.cM(H.Mj(null))},"tt","$get$tt",function(){return H.cM(function(){try{null.$method$}catch(z){return z.message}}())},"dt","$get$dt",function(){return H.cM(H.Mj(void 0))},"A7","$get$A7",function(){return H.cM(function(){try{(void 0).$method$}catch(z){return z.message}}())},"Wc","$get$Wc",function(){return P.Oj()},"xg","$get$xg",function(){return[]},"DB","$get$DB",function(){return["./","./favicon.ico","./game_web.dart.info.json","./game_web.dart.js","./packages/browser/dart.js","./packages/browser/interop.js","./packages/package_resolver/src/test_package_config","./packages/pop_pop_win/assets/audio/audio.json","./packages/pop_pop_win/assets/audio/audio.m4a","./packages/pop_pop_win/assets/audio/audio.mp3","./packages/pop_pop_win/assets/audio/audio.ogg","./packages/pop_pop_win/assets/audio/audio.opus","./packages/pop_pop_win/assets/images/animated.json","./packages/pop_pop_win/assets/images/dart_opaque_01.jpg","./packages/pop_pop_win/assets/images/dart_opaque_01.webp","./packages/pop_pop_win/assets/images/help-freeze.jpg","./packages/pop_pop_win/assets/images/help-surround.jpg","./packages/pop_pop_win/assets/images/icon_200.png","./packages/pop_pop_win/assets/images/opaque.json","./packages/pop_pop_win/assets/images/static.json","./packages/pop_pop_win/assets/images/transparent_animated.png","./packages/pop_pop_win/assets/images/transparent_animated.webp","./packages/pop_pop_win/assets/images/transparent_static.png","./packages/pop_pop_win/assets/images/transparent_static.webp","./packages/pop_pop_win/assets/style.css","./packages/test/dart.js","./packages/test/src/runner/browser/static/","./packages/test/src/runner/browser/static/host.css","./packages/test/src/runner/browser/static/host.dart.js","./pwa.dart.info.json"]},"LE","$get$LE",function(){return["https://fonts.google.com/","https://fonts.googleapis.com/","https://fonts.gstatic.com/"]},"Pj","$get$Pj",function(){return new L.Bb(self.self,null,null,null,null,null,null,null,null,null,null,null)},"tx","$get$tx",function(){return $.$get$Pj()}])
